          ...
          {locations.map((location) => (
            ...
            >
              <div className={`flex items-center justify-between ${lang === "ar" ? "flex-row-reverse" : "flex-row"}`}>
                <div className={`flex items-center ${lang === "ar" ? "flex-row-reverse space-x-reverse" : "flex-row"} space-x-4`}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {getAddressInLanguage(location) && (
                      <div className={`mt-2 flex items-start ${lang === "ar" ? "flex-row-reverse space-x-reverse" : "flex-row"} space-x-2`}>
                        <svg
                    ...
                    <div className={`mt-2 flex items-center space-x-2 ${lang === "ar" ? "flex-row-reverse space-x-reverse" : "flex-row"}`}>
                ...
                <div className={`flex ${lang === "ar" ? "flex-row-reverse space-x-reverse" : "flex-row"} space-x-2`}>
                  <button
