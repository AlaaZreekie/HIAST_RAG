...
"[project]/app/admin/mediaCategories/create/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CreateMediaCategoryPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CreateMediaCategoryPage.useEffect": ()=>{
            const checkAuth = {
                "CreateMediaCategoryPage.useEffect.checkAuth": async ()=>{
            ...
            }["CreateMediaCategoryPage.useEffect.checkAuth"];
            checkAuth();
        }
    }["CreateMediaCategoryPage.useEffect"], [
        router
    ...
    const handleSubmit = async (categoryData)=>{
        try {
            setIsLoading(true);
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mediaCategoriesApi$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mediaCategoriesAPI"].createMediaCategory(categoryData);
...
_s(CreateMediaCategoryPage, "ssutS2rtDMUpWLsUgdgG5Lwyg48=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$LanguageProvider$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"]
    ];
});
_c = CreateMediaCategoryPage;
var _c;
__turbopack_context__.k.register(_c, "CreateMediaCategoryPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_5dd58454._.js.map